...
public class FlujoAleatorio {
    ...
    public static int cuentaLetra(char caracter) throws IOException {
        ...
        try {
            acceso = new RandomAccessFile("datos.dat", "r");
            posicion = buscarLetra(caracter, acceso);
            while (posicion != -1) {
    ...
    private static int buscarLetra(char letra, RandomAccessFile acceso) {
